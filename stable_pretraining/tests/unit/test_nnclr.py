...
class TestNNCLRUnit:
    ...
    def test_nnclr_forward_with_queue(
        ...
        mock_online_queue._shared_queues.get.return_value.get.return_value = mock_support_set
    ...
    def test_nnclr_forward_no_queue(
        ...
        mock_online_queue._shared_queues.get.return_value.get.return_value = torch.tensor([])
